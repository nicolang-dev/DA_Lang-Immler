...
\usepackage{fancyhdr}
\fancyhf{}
%\fancyfoot[RE, LO]{\raisebox{2ex}{\thepage}} %Seitenanzahl im Footer
...
\includepdf[pages=1]{PSP_final.pdf} %fügt Deckblatt als PDF ein
\subsection{Anhang 1.3: Gantt-Diagramm}
\includepdf[pages=1]{Gantt_final.pdf} %fügt Deckblatt als PDF ein
\section{Anhang 2: UML-Klassendiagramm Adapter}
\includepdf[pages=1]{uml_klassen.pdf} %fügt Deckblatt als PDF ein
...
\mbox{}
\newpage
\section{Anhang 4: Zeichnung Gehäuse Adapter}
\includepdf[pages=1]{gehaeuse_zeichnung.pdf} %fügt Deckblatt als PDF ein
\end{document}