...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\linewidth]{/allgemein/MSA_Konzept.png}
...
\hline 
/getAvailableNetworks & GET & Der Server (MSA) sendet eine Liste, welche SSID und RSSI (Stärke) von den Netzwerken, welche sich in der Reichweite von diesem befinden, im JSON-Format an den Client. Diese werden in der Smartphone-App benötigt, um auszuwählen, mit welchem Netzwerk sich der MSA verbinden soll.\\
\hline
