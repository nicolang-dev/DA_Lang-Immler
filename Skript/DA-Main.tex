...
...
Dies lässt das UI modern und elegant erscheinen.
...
Die einzelnen Komponenten werden nicht wie zuerst vorgesehen auf eine Platine gelötet und dann mit dem Controller verbunden, sondern jeweils einzeln direkt mit dem Mikrocontroller. Bei diesem Prototyp lässt sich der Mikrocontroller nämlich vorerst als Platine betrachten, welcher zusätzliche Bauteile zugefügt werden.
